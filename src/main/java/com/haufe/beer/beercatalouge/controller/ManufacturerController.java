...
public class ManufacturerController {
     ...
     * @return the response entity with the created manufacturer.
     */
    @PatchMapping(value = "/{manufacturerId}/beers/add", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return the response entity with the created manufacturer.
     */
    @PatchMapping(value = "/{manufacturerId}/beers/remove", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
